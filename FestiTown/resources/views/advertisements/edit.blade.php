...
@section('title', 'Editar Anuncio - FestiTowns')

@section('content')
<div class="py-12">
    <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-lg p-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">✏️ Editar Anuncio</h1>
            ...
            <form action="{{ route('advertisements.update', $advertisement) }}" method="POST">
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="url" id="image_url" name="image_url" value="{{ old('image_url', $advertisement->image_url) }}" 
                    ...
                    <div>
                        ...
                        <select id="festive_id" name="festive_id" 
                            ...
                            @foreach($festives as $festive)
                                <option value="{{ $festive->id }}" {{ old('festive_id', $advertisement->festive_id) == $festive->id ? 'selected' : '' }}>
                ...
                <div class="flex justify-end space-x-4 mt-8">
                    <a href="{{ route('advertisements.show', $advertisement) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-md hover:bg-gray-700 transition-colors">
                        Cancelar
                    </a>
