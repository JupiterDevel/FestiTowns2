...
This document describes the legal compliance feature implemented in ElAlmaDeLasFiestas, which includes mandatory acceptance of Terms & Conditions and Cookies Policy for all users.
