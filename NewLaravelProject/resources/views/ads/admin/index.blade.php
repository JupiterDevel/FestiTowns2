<x-app-layout>
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
            <h1 class="display-6 fw-bold text-primary mb-0">
                <i class="bi bi-badge-ad me-2"></i>Publicidad Premium
            </h1>
    ...
    <div class="container">
        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="GET" action="{{ route('advertisements.index') }}" class="row g-3 align-items-end">
                    <div class="col-md-10">
                    ...
                    <thead class="table-light">
                        @php
                            ...
                            $sortLink = function (string $column) use ($baseQuery, $sort, $direction) {
                                ...
                                return route('advertisements.index', array_merge($baseQuery, [
                                    'sort' => $column,
