    ...
    <x-slot name="header">
        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex gap-2">
                <a href="{{ route('events.show', [$festivity, $event]) }}" class="btn btn-outline-secondary btn-custom">
            ...
            <div class="col-md-8">
                <div class="card shadow">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('events.update', [$festivity, $event]) }}">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          ...
                                          name="description" 
                                          rows="4" 
                                          placeholder="Describe el evento...">{{ old('description', $event->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
